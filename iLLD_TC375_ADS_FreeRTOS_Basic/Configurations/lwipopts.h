...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define NO_SYS                  0                   /* Enable RTOS integration (use tcpip thread, sys_arch primitives)      */
...
#define LWIP_TCP                1                   /* Enable TCP core (required for DoIP)                                  */
#define LWIP_UDP                1                   /* Ensure UDP support stays enabled for SOME/IP                         */
#define LWIP_ARP                1                   /* Enable ARP for IPv4 Ethernet                                         */
#define LWIP_ICMP               1                   /* Enable ICMP (ping)                                                   */
#define LWIP_DHCP               0                   /* Disable DHCP protocol                                                 */
#define LWIP_IPV4               1                   /* Enable IGMP (required for SOME/IP-SD)                                */
#define LWIP_NETCONN            0                   /* Keep Sequential API disabled (raw API only for now)                  */
#define LWIP_SOCKET             0                   /* BSD socket API disabled                                              */
#define SYS_LIGHTWEIGHT_PROT    1                   /* Enable inter-task protection (mutexes)                               */
#define LWIP_TIMERS             1                   /* Use lwIP internal timer management                                   */

#define LWIP_ICMP               1                   /* Enable ICMP protocol                                                 */
#define LWIP_ARP                1                   /* Enable ARP protocol                                                 */
/*---------------------------------------------------------------------------
 * Thread/stack configuration for FreeRTOS integration
 *---------------------------------------------------------------------------*/
