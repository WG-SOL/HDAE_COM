...
"Libraries/Ethernet/lwip/port/src/netif.o":"Libraries/Ethernet/lwip/port/src/netif.src" "Libraries/Ethernet/lwip/port/src/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"
"Libraries/Ethernet/lwip/port/src/sys_arch.src":"../Libraries/Ethernet/lwip/port/src/sys_arch.c" "Libraries/Ethernet/lwip/port/src/subdir.mk"
	cctc -cs --dep-file="$*.d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/USER/Documents/project2/iLLD_TC375_ADS_FreeRTOS_Basic/TriCore Debug (TASKING)/TASKING_C_C___Compiler-Include_paths__-I_.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<"
"Libraries/Ethernet/lwip/port/src/sys_arch.o":"Libraries/Ethernet/lwip/port/src/sys_arch.src" "Libraries/Ethernet/lwip/port/src/subdir.mk"
	astc -Og -Os --no-warnings= --error-limit=42 -o  "$@" "$<"

clean: clean-Libraries-2f-Ethernet-2f-lwip-2f-port-2f-src

clean-Libraries-2f-Ethernet-2f-lwip-2f-port-2f-src:
	-$(RM) ./Libraries/Ethernet/lwip/port/src/Ifx_Lwip.d ./Libraries/Ethernet/lwip/port/src/Ifx_Lwip.o ./Libraries/Ethernet/lwip/port/src/Ifx_Lwip.src ./Libraries/Ethernet/lwip/port/src/netif.d ./Libraries/Ethernet/lwip/port/src/netif.o ./Libraries/Ethernet/lwip/port/src/netif.src ./Libraries/Ethernet/lwip/port/src/sys_arch.d ./Libraries/Ethernet/lwip/port/src/sys_arch.o ./Libraries/Ethernet/lwip/port/src/sys_arch.src
